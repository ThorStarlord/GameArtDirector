...
| 2026-06-04 | Z Image Turbo | operations-center | Room test 10: metahuman command center | 9 | 5 | 7 | 8.0 | structure-collapse | none | Strong visual quality (9/10) but ops center accuracy (5/10). Central command pit and wall-sized tactical displays worked well. Metahuman keyword picked up. Multi-level floor, tiered analyst stations, glass mezzanine, restricted-access corridors all collapsed. Model excels at atmosphere/hierarchy but struggles with complex spatial organization (tiered, multi-level, mezzanine). Consistent pattern across all room tests: atmosphere > architectural structure. |
